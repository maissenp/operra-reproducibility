...
title: | 
  ...
  with R and Quarto -- geting started
...
-   **879 notebooks** produced results identical to those reported in the original notebook
:::
...
::::: incremental
::: fragment
-   Reproducible research is hard and may feel overwhealming
:::
...
`raw data` $\rightarrow$ dynamic reporting file $\rightarrow$ `manuscript`
